...
RCT_EXTERN_METHOD(setSocketIdentity:(NSString *)uuid value:(NSString *)value base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(socketSend:(NSString *)uuid body:(NSArray *)body base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(socketRecv:(NSString *)uuid flag:(NSInteger)flag base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
...
RCT_EXTERN_METHOD(socketSubscribe:(NSString *)uuid topic:(NSString *)topic base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
RCT_EXTERN_METHOD(socketUnsubscribe:(NSString *)uuid topic:(NSString *)topic base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
...
RCT_EXTERN_METHOD(setRoutingId:(NSString *)uuid value:(NSString *)value base64:(BOOL)base64 resolve:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject);
@end
